...
!define URL http://www.plasmacoin.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/plasmacoin.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\plasmacoin-qt.exe
...
OutFile plasmacoin-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/plasmacoin-qt.exe
    ...
    #Delete /REBOOTOK $INSTDIR\plasmacoin.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\plasmacoin-qt.exe
