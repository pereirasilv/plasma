...
// plasmacoin: total coins staked (non-spendable until maturity)
...
// plasmacoin: check 'spent' consistency between wallet and txindex
// plasmacoin: fix wallet spent state according to txindex
...
// plasmacoin: disable transaction (only for coinstake)
